...
<body class="">
                            ...
                            <li class="nav-item dropdown dropdown position-static">
                                              ...
                                              <div class="row py-3 py-lg-0 flex-wrap gx-4 gy-6">
                                                  ...
                                                  <div class="col">
                                                      ...
                                                      <ul class="list-unstyled">
                                                          ...
                                                          <li class="dropdown-list-item"><a class="dropdown-item" href="./category.php">Pintu Besi</a></li>
                                                          <li class="dropdown-list-item"><a class="dropdown-item" href="./category.php">Pintu Besi Sliding Dan Folding</a></li>
                                                          <li class="dropdown-list-item"><a class="dropdown-item" href="./category.php">Jasa Powder Coating</a></li>
                                                  ...
                                                  <div class="row g-4">
                                                      <div class="col-12 col-md-6">
                                                          <div class="card justify-content-center d-flex align-items-center bg-transparent">
                                                              ...
                                                              <a class="fw-bolder link-cover" href="./category.php">Powder Coating</a>
                                                          </div>
                                                      </div>
                                                      <div class="col-12 col-md-6">
                                                          <div class="card justify-content-center d-flex align-items-center bg-transparent">
                                                              ...
                                                              <a class="fw-bolder link-cover" href="./category.php">Pintu Besi</a>
                                                          </div>
                                                      </div>
                                                      <div class="col-12 col-md-6">
                                                          <div class="card justify-content-center d-flex align-items-center bg-transparent">
                                                              ...
                                                              <a class="fw-bolder link-cover" href="./category.php">Pintu Besi Sliding Dan Folding</a>
                                                          </div>
                                                      </div>
                                                      <div class="col-12 col-md-6">
                                                          <div class="card justify-content-center d-flex align-items-center bg-transparent">
                              ...
                              <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                  ...
                                  <li><a class="dropdown-item" href="./category.php">Katalog</a></li>
    ...
    <section class="mt-0 ">
        ...
        <div class="py-10 bg-img-cover bg-overlay-dark position-relative overflow-hidden bg-pos-center-center rounded-0"
            style="background-image: url(./assets/images/banners/pintubesi3.jpeg);">
            <div class="container-fluid position-relative z-index-20" data-aos="fade-right" data-aos-delay="300">
                <h1 class="fw-bold display-6 mb-4 text-white">KATALOG | DAESON - CV. WASKTAT KARYA METAL</h1>
                <div class="col-12 col-md-6">
                    <p class="text-white mb-0 fs-5">
                        Selamat Datang di Katalog Daeson - CV. Waskat Karya Metal
                    </p>
                </div>
            </div>
        </div>
            ...
            <!-- Category Toolbar-->
                <div class="d-flex justify-content-between items-center pt-5 pb-4 flex-column flex-lg-row">
                    <div>
                        ...
                        </nav>        <h1 class="fw-bold fs-3 mb-2">PRODUCT (9)</h1>
                        <p class="m-0 text-muted small">Showing 1 - 9 of 9</p>
                    </div>
                        ...
                        <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                            <div class="card-img position-relative">
                                <div class="card-badges">
                                        <span class="badge badge-card"><span class="f-w-2 f-h-2 bg-primary rounded-circle d-block me-1"></span> Sale</span>
                                </div>
                                <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                <picture class="position-relative overflow-hidden d-block bg-light">
                                    <img class="w-100 img-fluid position-relative z-index-10" title="" src="./assets/images/banners/katalog1.jpeg" alt="">
                                </picture>
                                    <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                        <button class="btn btn-quick-add"><i class="ri-whatsapp-fill"></i>Whatsapp</button>
                                    </div>
                            </div>
                            <div class="card-body px-0">
                                <a class="text-decoration-none link-cover" href="whatsapp://send?text=Hallo Saya Mau Pesan Nike Air VaporMax 2021!&phone=+8287875867132">Paket Komponen Lipat D800</a>
                                <small class="text-muted d-block">12 Item</small>
                                        <p class="mt-2 mb-0 small"><s class="text-muted">Rp.420.000</s> <span class="text-danger">Rp.320.000</span></p>
                            </div>
                        </div>
                        <!--/ Card Product-->
                    </div>
                    <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                            <div class="card-img position-relative">
                                ...
                                <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                <picture class="position-relative overflow-hidden d-block bg-light">
                                    <img class="w-100 img-fluid position-relative z-index-10" title="" src="./assets/images/banners/katalog2.jpeg" alt="">
                                </picture>
                                    <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                        <button class="btn btn-quick-add"><i class="ri-whatsapp-fill"></i>Whatsapp</button>
                                    </div>
                            ...
                            <div class="card-body px-0">
                                <a class="text-decoration-none link-cover" href="whatsapp://send?text=Hallo Saya Mau Pesan Nike Air VaporMax 2021!&phone=+8287875867132">Komponen Rel Garasi Dan Pintu Besi Powder Coating</a>
                                <small class="text-muted d-block">4 colours</small>
                                        <p class="mt-2 mb-0 small"><s class="text-muted">Rp.420.000</s> <span class="text-danger">Rp.320.000</span></p>
                            </div>
                        </div>
                        <!--/ Card Product-->
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                            <div class="card-img position-relative">
                                ...
                                <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                <picture class="position-relative overflow-hidden d-block bg-light">
                                    <img class="w-100 img-fluid position-relative z-index-10" title="" src="./assets/images/banners/katalog4.jpeg" alt="">
                                </picture>
                                    <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                        <button class="btn btn-quick-add"><i class="ri-whatsapp-fill"></i>Whatsapp</button>
                                    </div>
                            ...
                            <div class="card-body px-0">
                                <a class="text-decoration-none link-cover" href="whatsapp://send?text=Hallo Saya Mau Pesan Nike Air VaporMax 2021!&phone=+8287875867132">Paket Komponen Tikung D300 </a>
                                <small class="text-muted d-block">4 colours</small>
                                        <p class="mt-2 mb-0 small"><s class="text-muted">Rp.420.000</s> <span class="text-danger">Rp.320.000</span></p>
                            </div>
                        </div>
