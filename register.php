    ...
    <section
        ...
        <div class="col col-md-8 col-lg-6 col-xxl-5">
            <div class="shadow-xl p-4 p-lg-5 bg-white">
                <h1 class="text-center mb-5 fs-2 fw-bold">Buat Akun</h1>
                <!--LOGO-->
                ...
                <form method="POST">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="username" id="username" required="required" placeholder="Enter your Username" data-validation-required-message="Please enter your name."/>
                      <p class="help-block text-danger"></p>
                    </div>
                    <div class="form-group">
                      <label class="form-label" for="register-notelp">No.Telp</label>
                      <input type="text" class="form-control" name="telp" id="telp" required="required" placeholder="Enter Your Telp" data-validation-required-message="Please enter your name."/>
                      <p class="help-block text-danger"></p>
                    </div>
                    <div class="form-group">
                      <label class="form-label" for="register-email">Email address</label>
                      <input type="email" class="form-control" name="email" id="email" required="required" placeholder="name@email.com" data-validation-required-message="Please enter your name."/>
                      <p class="help-block text-danger"></p>
                    </div>
                    <div class="form-group">
                      <label class="form-label" for="register-password">Password</label>
                      <input type="password" class="form-control" name="pw" id="pw" required="required" placeholder="Enter your password" data-validation-required-message="Please enter your name."/>
                      <p class="help-block text-danger"></p>
                    </div>
                    <div id="success"></div>
                    <button type="submit" class="btn btn-dark d-block w-100 my-4" id="sendMessageButton" name="register">Sign Up</button>
                  </form>

                  <?php
                    if(isset($_POST['register']))
                    {
                        $koneksi = mysqli_connect("localhost","root","","db_daeson");
                        ...
                        $isi_data = mysqli_query($koneksi,"INSERT INTO user(username,telp,email,pw) 
                        VALUES ('$username','$telp','$email','$pw')");
